...
/*
    ...
    private val MIN_BITRATE = 2000000
    private val MIN_HEIGHT = 640.0
    private val MIN_WIDTH = 360.0
    private val FRAME_RATE = 30
    private val I_FRAME_INTERVAL = 2
    private val MIME_TYPE = "video/avc"
    private val MEDIACODEC_TIMEOUT_DEFAULT = 100L

    var isRunning = true

    fun compressVideo( source: String,  destination: String, quality: Int,  isMinBitRateEnabled: Boolean, listener: CompressionProgressListener): {
        ...
        val heightData = mediaMetadataRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_HEIGHT)

        val widthData = mediaMetadataRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_WIDTH)
    ...
    /*private fun setUpMP4Movie( rotation: Int, cacheFile: File,): Mp4Movie {
        val movie = Mp4Movie()
        movie.apply {
    ...
    private fun setOutputFileParameters(outputFormat: MediaFormat,newBitrate: Int, frameRate: Int, iFrameInterval: Int, resultHeight: Int, resultWidth: Int ) {
        outputFormat.apply {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                var capabilities: MediaCodecInfo.CodecCapabilities? =
                    MediaCodecInfo.CodecCapabilities.createFromProfileLevel( MIME_TYPE, profile, level )
                ...
                if (capabilities?.encoderCapabilities != null) {
                    ...
                    val maxBitrate: Int =  capabilities.videoCapabilities.bitrateRange.upper
                    if (newBitrate > maxBitrate) {
                        setInteger(MediaFormat.KEY_BIT_RATE, maxBitrate)
                    }
                    val maxFrameRate: Int =  capabilities.videoCapabilities.supportedFrameRates.upper
    ...
    private fun processAudio( extractor: MediaExtractor,  mediaMuxer: MP4Builder,  bufferInfo: MediaCodec.BufferInfo, ) {
