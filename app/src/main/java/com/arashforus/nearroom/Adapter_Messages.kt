...
class Adapter_Messages(val messages: ArrayList<Object_Message>) : RecyclerView.Adapter<Adapter_Messages.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(message: Object_Message) {
            when (message.type.toUpperCase(Locale.ROOT).trim()) {
                "TEXT" -> {
                    ...
                    if (message.senderId == myId){
                        ...
                        itemView.findViewById<TextView>(R.id.yourchat_sender).visibility = View.GONE
                    }
                ...
                "PIC" -> {
                    ...
                    if (message.senderId == myId){
                        ...
                        //status = itemView.findViewById(R.id.MyChat_Media_Tik)
                        itemView.findViewById<TextView>(R.id.YourChat_Media_Sender).visibility = View.GONE
                    }
                        ...
                        if ( MyExternalStorage(itemView.context).isImageAvailable(message.uri!!) ){
                            ...
                            if ( MyInternalStorage(itemView.context).isPicThumbAvailable(message.uri!!) ){
                                Glide.with(itemView.context)
                                    ...
                                    .placeholder(R.drawable.noimage)
                                    .apply(reqOpt)
                                    .transform(CenterCrop(),BlurTransformation(25,3),RoundedCorners(blurCorner))
                                    .dontAnimate()
                                    .override((width * 0.7).roundToInt())
                                    .dontAnimate()
                                    .into(pic)
                ...
                "VID" -> {
                    ...
                    if (message.senderId == myId){
                        ...
                        itemView.findViewById<TextView>(R.id.YourChat_Video_Sender).visibility = View.GONE
                    }
                ...
                "AUD" -> {
                    ...
                    if (message.senderId == myId){
                        ...
                        itemView.findViewById<TextView>(R.id.YourChat_Audio_Sender).visibility = View.GONE
                    }
                ...
                "FILE" -> {
                    ...
                    if (message.senderId == myId){
                        ...
                        itemView.findViewById<TextView>(R.id.YourChat_File_Sender).visibility = View.GONE
                    }
        ...
        seekTimer.schedule(object : TimerTask() {
            override fun run() {
                ( context as Activity ).runOnUiThread {
                    ...
                    currentDuration.text =  "${MyTools(context).secondToFullTime(mediaPlayer.duration/1000)} ( ${MyTools(context).secondToFullTime(mediaPlayer.currentPosition / 1000)} )"
                }
            }
