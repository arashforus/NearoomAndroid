...
class Volley_DeleteProfilePic(val context: Context, val myId :Int , var callback : ServerCallBack?) {
    ...
    // Deleting profile picture from server DB /////////////////////////////////////////////////////
    fun send() {
        val url = MyServerSide.deleteProfilePic
        val body = JSONObject()
        body.put("myId",myId)
