...
class Volley_LeaveNearoom(val context: Context, val roomId :Int, val myId : Int , var callback : ServerCallBack?) {
    ...
    val tag = "LeaveNearoom"

    // Leaving the nearoom /////////////////////////////////////////////////////////////////////////
    fun send() {
        val url = MyServerSide.leaveNearoom
        val body = JSONObject()
        body.put("myId",myId)
