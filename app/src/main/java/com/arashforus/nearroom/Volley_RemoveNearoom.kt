...
class Volley_RemoveNearoom(val context: Context, val roomId :Int, val myId : Int, var callback : ServerCallBack?) {
    ...
    val tag = "RemoveNearoom"

    // Remove the nearoom //////////////////////////////////////////////////////////////////////////
    fun send() {
        val url = MyServerSide.removeNearoom
        val body = JSONObject()
        body.put("myId",myId)
